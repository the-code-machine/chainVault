            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <Link
                  ...
                  className={`group relative flex items-center  gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/case-management' ?
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center  gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/case-management/view-history' ?
                    ' bg-white text-primary' : 'text-white bg-transparent'
                    }`}
                >
              ...
              <li>
                <Link
                  href="/case-management/personal-doc"
                  className={`group relative flex items-center text-white gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/case-management/personal-doc' ?
                    ' bg-white text-primary' : 'text-white bg-transparent'
                    }`}
                >
              ...
              <li>
                <Link
                  href="/case-management/sharedDocument"
                  className={`group relative flex items-center  gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/case-management/sharedDocument' ?
                    ' bg-white text-primary' : 'text-white bg-transparent'
                    }`}
                >
              ...
              <li>
                <Link
                  href="/case-management/settings"
                  className={`group relative flex items-center  gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/case-management/settings' ?
                    ' bg-white text-primary' : 'text-white bg-transparent'
                    }`}
                >
                  <svg
