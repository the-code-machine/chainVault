...
export default () => {
    ...
    return (
        <footer className="pt-10   bg-[#792938]">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                            ...
                            >
                                <h4 className="text-white font-semibold sm:pb-2">
                                    ...
                                    item.items.map(((el, idx) => (
                                        <li key={idx}>
                                            {!(el.href.includes('about') || el.href.includes('features') || el.href.includes('contact')) ?
                                                     <Link
                                                     href={el.href}
                ...
                <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
                    <p className="text-white">© 2022 eVault UI Inc. All rights reserved.</p>
