    ...
    <>
      <div className=" w-screen h-36  bg-bg-secondary flex justify-between px-8 py-5">
        <div className=" w-1/2 flex space-x-5 ">
          <img
            src="https://gwalior.dcourts.gov.in/wp-content/themes/sdo-theme/images/emblem.svg"
            className=" h-full "
          />
          <div className=" flex flex-col  text-black text-lg">
            <h1>डिजिटल भारत से सशक्त भारत</h1>
            <p className=" text-4xl font-bold">eVault for Legal Records</p>
            <h1>विधिक रिकॉर्ड के लिए ई-वॉल्ट</h1>
          </div>
        </div>
        <div className=" w-1/2 flex space-x-5 justify-end">
          <img
            src="https://gwalior.dcourts.gov.in/wp-content/themes/sdo-theme/images/digital-india.png"
            className="h-full"
          />
        </div>
      </div>
  ...
  return (
    <>
      <div className=" w-screen h-12 bg-primary flex px-8  justify-between items-center">
        ...
        {user.login ? (
          <div className=" bg-white text-[#792938] font-medium px-2 py-1.5 w-24 overflow-hidden text-ellipsis">
            {user?.address}
          </div>
        ) : (
          <Link
            href={"/auth/login"}
            className=" bg-white text-[#792938] font-medium px-4 py-1.5"
          >
            Login
          </Link>
        )}
      ...
      {innerItems != [] && (
        ...
        >
          {!(
            ...
            <Link1
              to={href}
              className="relative text-gray-200 cursor-pointer hover:text-white"
              smooth
              duration={2000}
            >
              {children}
